...
def validate(model, data_loader, criterion, epoch):
    ...
    if best_loss is None:
        ...
        best_loss = avg_loss
        count = 0
        save_model(model, 'model_0915_5.pth', total_loss, total_loss / len(data_loader), best_loss, train_acc, accuracy, epoch)
...
if __name__ == "__main__":
    if LearnTask:
        ...
        loaded_model = load_model('model_0915_5.pth', 'data_true_PRED_copy.xlsx', 'data_true_PRED_copy.csv')
