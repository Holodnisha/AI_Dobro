...
class MyDataset(Dataset):
    def __init__(self, csv_file):
        ...
        if LearnTask and vectorize_num:
            ...
            joblib.dump(self.vectorizer, "vectorizer_0915_3.pkl")
            print("save vectorizer")
        else:
            print("load vectorizer")
            self.vectorizer = joblib.load("vectorizer_0915_3.pkl")
...
def validate(model, data_loader, criterion, epoch):
    ...
    if best_loss is None:
        ...
        best_loss = avg_loss
        count = 0
        save_model(model, 'model_0915_3.pth', total_loss, total_loss / len(data_loader), best_loss, train_acc, accuracy, epoch)
...
if __name__ == "__main__":
    if LearnTask:
        ...
        loaded_model = load_model('model_0915_3.pth', 'data_true_PRED_copy.xlsx', 'data_true_PRED_copy.csv')
        prediction = predict(loaded_model, 'data_true_PRED_copy.xlsx', 'data_true_PRED_copy.csv')
